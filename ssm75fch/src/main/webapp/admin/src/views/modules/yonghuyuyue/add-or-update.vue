        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="乐室状态" prop="leshizhuangtai">
          <el-input v-model="ruleForm.leshizhuangtai" 
              placeholder="乐室状态" clearable  :readonly="ro.leshizhuangtai"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  computed: {
                                                                                                            zongjiage:{
                                                                                                                                                                                                                                                                                                      get: function () {
        return 1*this.ruleForm.yuyuejiage*this.ruleForm.shiyongshizhang
      }
    },
                                                                                                                                      },
  created() {
